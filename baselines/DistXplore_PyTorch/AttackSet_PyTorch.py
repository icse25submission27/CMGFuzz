...
def main():
    ...
    parser.add_argument('-model_type', help='model',
                        choices=['lenet1', 'lenet5', 'resnet20', 'mobilenet', 'vgg16', 'resnet50'], default='lenet5')#Abandoned
    ...
    # Load nes；nes中保存了target类别的 样本的的特征，在之前实现的过程中，为了方便记录indiv距离所有类别的距离，这里加载时所有类别的样本都有加载
    if args.target != -1:
